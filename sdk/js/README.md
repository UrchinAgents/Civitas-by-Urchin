...
const client = new OpenAI({
    apiKey: process.env['URCHIN_API_KEY'], // This is the default and can be omitted
    baseURL: "https://api.urchin.com/v1/verified",
});
...
async function main() {
    const result = await Civitas.getHistory(process.env['URCHIN_API_KEY'])
    console.log(result)
}
