...
client = OpenAI(
    base_url="https://api.urchin.com/v1/verified",
    api_key="Bearer URCHIN_API_KEY",
)
...
import civitas
from civitas.history import UrchinChatHistory

history: List[UrchinChatHistory] = civitas.get_history(
    urchin_api_key="Bearer URCHIN_API_KEY"
)
...
item: UrchinChatHistory = civitas.get_by_hash(
    urchin_api_key="Bearer URCHIN_API_KEY",
