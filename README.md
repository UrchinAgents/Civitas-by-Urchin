...
<img src="assets/urchin-banner.jpg" alt="Banner" width="100%" />
<p align="center">
      <a href="https://x.com/urchinagent">
      <img src="https://img.shields.io/twitter/follow/urchinagent"
...
4. The TEE submits the attestation with {Message, Proof} to Base.
5. The Proof of Civitas SDK is used to read the attestation from Base and verify it with {Message, Proof}. The proof log can be added to the agent website/app.
...
5. **Transparency and verifiability:** By posting the attestation on Base, an Ethereum Layer 2, any third party can transparently verify the provenance and authenticity of the request and its associated output without relying on trust in a single centralized entity.

To verify the code running inside the TEE, use instructions [from here](https://github.com/UrchinAgents/Civitas-by-Urchin/tree/main/verified-inference/verify).
...
**On-chain verifiability with Base.**
...
1. [Python SDK](https://github.com/UrchinAgents/Civitas-by-Urchin/tree/main/sdk/python)
2. [Javascript SDK](https://github.com/UrchinAgents/Civitas-by-Urchin/tree/main/sdk/js)

### **Verified inference**

Underlying TEE architecture that powers Proof of Civitas.

1. [enclave](https://github.com/UrchinAgents/Civitas-by-Urchin/tree/main/verified-inference/enclave) - this where the enclave is built and run
2. [host](https://github.com/UrchinAgents/Civitas-by-Urchin/tree/main/verified-inference/host) - proxies HTTP requests to the API running in the enclave
3. [verify](https://github.com/UrchinAgents/Civitas-by-Urchin/tree/main/verified-inference/verify) - instructions and code for verifying the TEE
...
- **Decentralized Agent Governance**
  ...
  - Launch of governance tools, empowering $URCHIN holders to vote on platform updates, feature releases, and development priorities.
